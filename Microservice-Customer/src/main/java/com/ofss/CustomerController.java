...
public class CustomerController {
	...
	@RequestMapping(value="/customers/{customername}/stocksList",method=RequestMethod.GET)
	public List<Stock> getCustomerStocksbyCustomerName(@PathVariable(value="customername") String customername)
	{
		System.out.println("Entering getCustomerStocks");
		List<Stock> allStocks=new ArrayList();
		Customer cust=null;
	...
	public String info()
	{
		String msg="Exposed endpoints:- </br> /customers:- get all customers </br> /customers/{customerid}:- get customer for customerid </br> /customers/{customerid}/stockids:- get stock list for customerid";
		return msg;
	}
